            ...
            if(!mt5Accounts.hasOwnProperty(accType)) {
                if(page.client.is_virtual()) {
                    ...
                    findInSection(accType, '.msg-account').html(hasRealBinaryAccount && (/financial/.test(accType)) ?
                        text.localize('To create a Financial Account for MT5, switch to your [_1] Real Account.', ['Binary.com']) :
                        text.localize('To create a Volatility Indices Account for MT5, switch to your [_1] Real Account.', ['Binary.com'])
